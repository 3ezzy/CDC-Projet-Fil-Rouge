...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-playfair font-bold text-gray-800 mb-2">Product Management</h1>
            <p class="text-gray-600">Add and manage products</p>
        </div>
        <a href="{{ route('products.create') }}" class="bg-amber-600 hover:bg-amber-700 text-white px-6 py-2 rounded-lg transition-colors">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
        <form action="{{ route('products.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <select name="stock_status" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    <img src="{{ asset('storage/' . $product->image_path) }}" alt="Product" class="w-12 h-12 rounded-lg object-cover">
                                    <div>
